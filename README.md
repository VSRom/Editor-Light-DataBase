...
## Рабочий функционал
	...
	Работа с БД:
	- Объединение данных нескольких таблиц с фильтрацией значений в колонках. При помощи создания новой реальной таблицы.
...
## Планируемый функционал
	...
	- Объединение данных нескольких таблиц с фильтрацией значений в колонках. При помощи создания новой виртуальной таблицы.
